...
export const INVENTORY_PRODUCTS: InventoryProduct[] = [
  {
    id: 'GF-P-001',
    productCode: 'GF-LUNCH-001',
    name: '그리팅 영양균형 도시락',
    affiliate: '현대그린푸드',
    category: '케어푸드/도시락',
    brand: '그리팅',
    channel: '그리팅몰 · 단체급식몰',
    description: '영양 균형을 고려한 냉동 도시락 제품군으로 메뉴와 중량별 SKU를 별도로 관리합니다.',
    imageUrl: 'https://images.unsplash.com/photo-1547592180-85f173990554?auto=format&fit=crop&w=1400&q=85',
    imageAlt: '채소와 단백질 반찬으로 구성된 영양균형 도시락',
    updatedAt: '2026.08.02 09:00',
    skus: [
      {
        id: 'GF-SKU-001', code: 'GF-LUNCH-BEEF-350', optionLabel: '소불고기 도시락 · 350g',
        options: { 메뉴: '소불고기', 중량: '350g', 보관: '냉동' },
        stock: 284, availableStock: 250, reservedStock: 34, unit: '개', sellingPrice: 8900,
        storageDays: 88, expiryLabel: 'D-45', salesVelocity: 4.2, riskStatus: 'WARNING', riskScore: 74,
        riskReason: '현재 판매속도라면 소비기한 시점에 약 61개가 남을 것으로 예상됩니다.',
        location: '경기 광주 냉동센터 F-01', updatedAt: '2026.08.02 09:00',
      },
      {
        id: 'GF-SKU-002', code: 'GF-LUNCH-CHK-350', optionLabel: '닭가슴살 현미 도시락 · 350g',
        options: { 메뉴: '닭가슴살 현미', 중량: '350g', 보관: '냉동' },
        stock: 126, availableStock: 118, reservedStock: 8, unit: '개', sellingPrice: 9200,
        storageDays: 35, expiryLabel: 'D-62', salesVelocity: 8.1, riskStatus: 'SAFE', riskScore: 28,
        riskReason: '최근 판매속도 기준 소비기한 이전 정상 소진이 예상됩니다.',
        location: '경기 광주 냉동센터 F-02', updatedAt: '2026.08.02 09:00',
      },
      {
        id: 'GF-SKU-003', code: 'GF-LUNCH-TOFU-350', optionLabel: '두부버섯 도시락 · 350g',
        options: { 메뉴: '두부버섯', 중량: '350g', 보관: '냉동' },
        stock: 462, availableStock: 435, reservedStock: 27, unit: '개', sellingPrice: 8500,
        storageDays: 62, expiryLabel: 'D-38', salesVelocity: 8.2, riskStatus: 'CAUTION', riskScore: 51,
  ...
  {
    id: 'GF-P-003',
    productCode: 'GF-SOUP-021',
    name: '그리팅 저당 한식 국·탕',
    affiliate: '현대그린푸드',
    category: '케어푸드/저당식',
    brand: '그리팅',
    channel: '그리팅몰 · Hmall',
    description: '당류와 나트륨을 낮춘 냉동 국·탕 제품으로 메뉴와 묶음 수량별 재고를 관리합니다.',
    imageUrl: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=1400&q=85',
    imageAlt: '채소와 단백질로 구성된 건강식 한식 메뉴',
    updatedAt: '2026.08.02 09:00',
    skus: [
      {
        id: 'GF-SKU-007', code: 'GF-SOUP-SEA-06', optionLabel: '소고기 미역국 · 6팩',
        options: { 메뉴: '소고기 미역국', 구성: '6팩', 보관: '냉동' },
        stock: 148, availableStock: 132, reservedStock: 16, unit: '세트', sellingPrice: 43800,
        storageDays: 21, expiryLabel: 'D-18', salesVelocity: 14.2, riskStatus: 'SAFE', riskScore: 18,
        riskReason: '최근 판매속도가 안정적이며 소비기한 이전 충분한 소진이 예상됩니다.',
        location: '경기 광주 냉동센터 F-21', updatedAt: '2026.08.02 09:00',
      },
      {
        id: 'GF-SKU-008', code: 'GF-SOUP-CHK-06', optionLabel: '닭곰탕 · 6팩',
        options: { 메뉴: '닭곰탕', 구성: '6팩', 보관: '냉동' },
        stock: 96, availableStock: 88, reservedStock: 8, unit: '세트', sellingPrice: 46800,
        storageDays: 16, expiryLabel: 'D-21', salesVelocity: 9.8, riskStatus: 'SAFE', riskScore: 25,
        riskReason: '예약재고와 반복 구매 수요가 확보되어 정상 관리 범위입니다.',
        location: '경기 광주 냉동센터 F-22', updatedAt: '2026.08.02 09:00',
      },
      {
        id: 'GF-SKU-009', code: 'GF-SOUP-MSH-06', optionLabel: '버섯 들깨탕 · 6팩',
        options: { 메뉴: '버섯 들깨탕', 구성: '6팩', 보관: '냉동' },
        stock: 122, availableStock: 110, reservedStock: 12, unit: '세트', sellingPrice: 45600,
        storageDays: 27, expiryLabel: 'D-15', salesVelocity: 7.3, riskStatus: 'CAUTION', riskScore: 43,
        riskReason: '현재는 정상 소진 범위지만 최근 7일 판매속도가 소폭 감소했습니다.',
        location: '경기 광주 냉동센터 F-23', updatedAt: '2026.08.02 09:00',
      },
    ],
  },
  {
  ...
  {
    id: 'WL-P-003',
    productCode: 'WL-OMEGA-310',
    name: '알티지 오메가3 밸런스',
    affiliate: '현대웰니스',
    category: '건강기능식품/오메가3',
    brand: 'H.Well',
    channel: '현대웰니스몰 · Hmall',
    description: '섭취 기간과 포장 구성에 따라 SKU를 구분하고 LOT별 소비기한과 이력추적 정보를 관리합니다.',
    imageUrl: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=1400&q=85',
    imageAlt: '캡슐 형태의 오메가3 건강기능식품',
    updatedAt: '2026.08.02 08:45',
    skus: [
      {
        id: 'WL-SKU-007', code: 'WL-OMG-060', optionLabel: '60캡슐 · 1개월분',
        options: { 용량: '60캡슐', 섭취기간: '1개월', 포장: '단품' },
        stock: 338, availableStock: 321, reservedStock: 17, unit: '병', sellingPrice: 32900,
        storageDays: 35, expiryLabel: 'D-310', salesVelocity: 17.2, riskStatus: 'SAFE', riskScore: 16,
        riskReason: '신규 입고 LOT이며 정기구매 수요가 안정적으로 유지되고 있습니다.',
        location: '이천 상온센터 W-31', updatedAt: '2026.08.02 08:45',
      },
      {
        id: 'WL-SKU-008', code: 'WL-OMG-120', optionLabel: '120캡슐 · 2개월분',
        options: { 용량: '120캡슐', 섭취기간: '2개월', 포장: '단품' },
        stock: 204, availableStock: 190, reservedStock: 14, unit: '병', sellingPrice: 57900,
        storageDays: 48, expiryLabel: 'D-280', salesVelocity: 12.6, riskStatus: 'SAFE', riskScore: 23,
        riskReason: '현재 재고와 판매속도 모두 정상 관리 기준을 충족합니다.',
        location: '이천 상온센터 W-32', updatedAt: '2026.08.02 08:45',
      },
      {
        id: 'WL-SKU-009', code: 'WL-OMG-180G', optionLabel: '60캡슐 × 3입 · 선물형',
        options: { 용량: '180캡슐', 섭취기간: '3개월', 포장: '선물박스' },
        stock: 126, availableStock: 118, reservedStock: 8, unit: '세트', sellingPrice: 89900,
        storageDays: 84, expiryLabel: 'D-230', salesVelocity: 5.9, riskStatus: 'CAUTION', riskScore: 45,
        riskReason: '선물형 상품의 판매속도가 평시 수준으로 돌아와 주간 관찰이 필요합니다.',
        location: '이천 상온센터 W-33', updatedAt: '2026.08.02 08:45',
      },
    ],
  },
  {
  ...
  {
    id: 'LV-P-003',
    productCode: 'LV-BED-520',
    name: '포레스트 원목 침대 프레임',
    affiliate: '현대리바트',
    category: '침실가구/침대',
    brand: '리바트',
    channel: '리바트몰 · 리바트 집테리어',
    description: '프레임 색상과 규격에 따라 SKU를 구분하고 센터 재고와 설치 가능 수량을 관리합니다.',
    imageUrl: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=1400&q=85',
    imageAlt: '따뜻한 원목 프레임으로 구성된 침실과 침대',
    updatedAt: '2026.08.02 07:30',
    skus: [
      {
        id: 'LV-SKU-007', code: 'LV-FOR-OAK-Q', optionLabel: '내추럴 오크 · 퀸',
        options: { 색상: '내추럴 오크', 규격: '퀸', 헤드: '기본형' },
        stock: 28, availableStock: 24, reservedStock: 4, unit: '조', sellingPrice: 890000,
        storageDays: 41, expiryLabel: '시즌 D-120', salesVelocity: 2.4, riskStatus: 'SAFE', riskScore: 19,
        riskReason: '온라인 주문과 입주 고객 예약 물량이 안정적으로 유지되고 있습니다.',
        location: '용인 가구센터 L-C11', updatedAt: '2026.08.02 07:30',
      },
      {
        id: 'LV-SKU-008', code: 'LV-FOR-WAL-Q', optionLabel: '월넛 · 퀸',
        options: { 색상: '월넛', 규격: '퀸', 헤드: '기본형' },
        stock: 18, availableStock: 15, reservedStock: 3, unit: '조', sellingPrice: 950000,
        storageDays: 69, expiryLabel: '시즌 D-120', salesVelocity: 1.3, riskStatus: 'CAUTION', riskScore: 42,
        riskReason: '정상 관리 범위이나 내추럴 오크 대비 판매속도가 낮아 관찰이 필요합니다.',
        location: '용인 가구센터 L-C12', updatedAt: '2026.08.02 07:30',
      },
      {
        id: 'LV-SKU-009', code: 'LV-FOR-OAK-K', optionLabel: '내추럴 오크 · 킹',
        options: { 색상: '내추럴 오크', 규격: '킹', 헤드: '확장형' },
        stock: 12, availableStock: 10, reservedStock: 2, unit: '조', sellingPrice: 1090000,
        storageDays: 32, expiryLabel: '시즌 D-120', salesVelocity: 1.1, riskStatus: 'SAFE', riskScore: 27,
        riskReason: '재고수량이 낮고 예약 주문이 확보되어 정상 소진이 예상됩니다.',
        location: '용인 가구센터 L-C13', updatedAt: '2026.08.02 07:30',
      },
    ],
  },
];
...
export const BUNDLE_RECOMMENDATIONS: BundleRecommendation[] = [
  { productId: 'GF-P-001', reason: '영양균형 도시락은 건강관리 상품과 함께 정기구매로 전환하기 좋습니다.', fitScore: 92 },
  { productId: 'GF-P-002', reason: '신선식품을 함께 제안해 웰니스 식단 패키지로 확장할 수 있습니다.', fitScore: 88 },
  { productId: 'WL-P-001', reason: '영양균형 도시락과 비타민의 섭취 주기가 비슷해 건강 루틴 구성이 가능합니다.', fitScore: 90 },
